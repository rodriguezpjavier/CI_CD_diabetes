...
experiment_name = "CI-CD-diabetes"
...
try:
    if experiment is None:
        ...
        # Si existe, extraemos su ID para usarlo
        print(f"--- El experimento '{experiment_name}' ya existe. Usando ID: {experiment.experiment_id} ---")
        experiment_id = experiment.experiment_id
        # 2. Asignar el experimento activo usando el ID obtenido
...
try:
    ...
    with mlflow.start_run(experiment_id=experiment_id) as run: # <--- CAMBIO CLAVE
        ...
        print("✅ Archivo model.pkl generado en la raíz para validación.")
